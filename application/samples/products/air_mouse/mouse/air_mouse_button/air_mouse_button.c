...
#define GPIO_ROW_5                  3   // ROW3 gpio管脚号

// Keyscan的gpio矩阵，COL在前，ROW在后
static const uint8_t user_gpio_map[GPIO_MAP_NUM] = {
    GPIO_COL_1, GPIO_COL_2, GPIO_COL_3, GPIO_COL_4,
    GPIO_ROW_1, GPIO_ROW_2, GPIO_ROW_3, GPIO_ROW_4, GPIO_ROW_5
};
...
// 按键序号对应的值
static uint8_t g_value_map[K17 + 1] = {};

void init_value_map(void)
{
    g_value_map[K1] = MOUSE_LEFT_CODE;
    g_value_map[K2] = KEYBOARD_HID_CODE_RIGHT;
    g_value_map[K3] = KEYBOARD_HID_CODE_ESC;
    g_value_map[K4] = MOUSE_LEFT_CODE;
    g_value_map[K5] = MOUSE_LEFT_CODE;
    g_value_map[K6] = KEYBOARD_HID_CODE_LEFT;
    g_value_map[K7] = MOUSE_LEFT_CODE;
    g_value_map[K8] = MOUSE_LEFT_CODE;
    g_value_map[K9] = KEYBOARD_HID_CODE_ESC;
    g_value_map[K10] = KEYBOARD_HID_CODE_ESC;
    g_value_map[K11] = MOUSE_LEFT_CODE;
    g_value_map[K12] = MOUSE_LEFT_CODE;
    g_value_map[K13] = MOUSE_LEFT_CODE;
    g_value_map[K14] = MOUSE_LEFT_CODE;
    g_value_map[K15] = KEYBOARD_HID_CODE_UP;
    g_value_map[K16] = KEYBOARD_HID_CODE_ENTER;
    g_value_map[K17] = KEYBOARD_HID_CODE_DOWN;
}
