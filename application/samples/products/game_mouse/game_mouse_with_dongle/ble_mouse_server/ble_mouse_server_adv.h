...
/* Ble not support br/edr flag data */
#define BLE_NO_SUPPORT_ADV_FLAG_DATA 0x04
/* Ble adv flag uuid */
#define BLE_SERVICE_CLASS_UUID 0x03
/* Ble Manufacture Data type */
#define BLE_ADV_MANUFACTURE_DATA_TYPE 0xFF
...
{
    return (uint8_t)(((uint16_t)(val) >> 8) & 0xff);  // 取高8位
}
...
#define BLE_ADV_MIN_INTERVAL 0x20 // 0x30
/* Ble adv max interval */
#define BLE_ADV_MAX_INTERVAL 0x20 // 0x60
/* Ble adv handle */
#define BTH_GAP_BLE_ADV_HANDLE_DEFAULT 0x01
/* Ble adv duration */
#define BTH_GAP_BLE_ADV_FOREVER_DURATION 0
/* Ble direct adv duration */
#define BTH_GAP_BLE_DIRECT_ADV_FOREVER_DURATION 1280
