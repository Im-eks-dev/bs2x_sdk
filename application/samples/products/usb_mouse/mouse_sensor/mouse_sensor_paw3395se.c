 ...
 *
 * Description: Test mouse sensor 3395se source \n
 * Author: @CompanyNameTag \n
 * History: \n
 * 2024-7-31, Create file. \n
 */
...
mouse_sensor_oprator_t g_usb_paw3395se_operator = {
    .get_xy = paw3395se_get_xy,
    .init = paw_3395se_mouse_init,
};

mouse_sensor_oprator_t usb_mouse_get_paw3395se_operator(void)
{
    return g_usb_paw3395se_operator;
}