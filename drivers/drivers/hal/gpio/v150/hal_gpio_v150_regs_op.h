...
#define hal_gpio_set_bit_high(x, y) hal_gpio_set_bit(x, y, 1U)
#endif
...
#if defined(CONFIG_GPIO_SUPPORT_MULTISYSTEM)
/**
 * @brief  Set the value of @ref gpio_info_regs.gpio_data_oen_set.
 * @param  [in]  channel The channel id of gpio.
 * @param  [in]  group The group id of gpio.
 * @param  [in]  group_pin The bit of gpio in group.
 * @param  [in]  val The value of @ref gpio_info_regs.gpio_data_oen_set.
 */
static inline void hal_gpio_gpio_data_oen_set_set_bit(uint32_t channel, uint32_t group, uint32_t group_pin)
{
    gpios_v150_regs(channel)->gpio_group_cfg[group].gpio_data_oen_set =
        hal_gpio_set_bit_high(gpios_v150_regs(channel)->gpio_group_cfg[group].gpio_data_oen_set, group_pin);
}

/**
 * @brief  Set the value of @ref gpio_info_regs.gpio_data_oen_clr.
 * @param  [in]  channel The channel id of gpio.
 * @param  [in]  group The group id of gpio.
 * @param  [in]  group_pin The bit of gpio in group.
 * @param  [in]  val The value of @ref gpio_info_regs.gpio_data_oen_clr.
 */
static inline void hal_gpio_gpio_data_oen_clr_set_bit(uint32_t channel, uint32_t group, uint32_t group_pin)
{
    gpios_v150_regs(channel)->gpio_group_cfg[group].gpio_data_oen_clr =
        hal_gpio_set_bit_high(gpios_v150_regs(channel)->gpio_group_cfg[group].gpio_data_oen_clr, group_pin);
}

/**
 * @brief  Set the value of @ref gpio_info_regs.gpio_sw_ctl_set.
 * @param  [in]  channel The channel id of gpio.
 * @param  [in]  group The group id of gpio.
 * @param  [in]  group_pin The bit of gpio in group.
 * @param  [in]  val The value of @ref gpio_info_regs.gpio_sw_ctl_set.
 */
static inline void hal_gpio_gpio_sw_ctl_set_set_bit(uint32_t channel, uint32_t group, uint32_t group_pin)
{
    gpios_v150_regs(channel)->gpio_group_cfg[group].gpio_sw_ctl_set =
        hal_gpio_set_bit_high(gpios_v150_regs(channel)->gpio_group_cfg[group].gpio_sw_ctl_set, group_pin);
}

/**
 * @brief  Set the value of @ref gpio_info_regs.gpio_sw_ctl_clr.
 * @param  [in]  channel The channel id of gpio.
 * @param  [in]  group The group id of gpio.
 * @param  [in]  group_pin The bit of gpio in group.
 * @param  [in]  val The value of @ref gpio_info_regs.gpio_sw_ctl_clr.
 */
static inline void hal_gpio_gpio_sw_ctl_clr_set_bit(uint32_t channel, uint32_t group, uint32_t group_pin)
{
    gpios_v150_regs(channel)->gpio_group_cfg[group].gpio_sw_ctl_clr =
        hal_gpio_set_bit_high(gpios_v150_regs(channel)->gpio_group_cfg[group].gpio_sw_ctl_clr, group_pin);
}

/**
 * @brief  Set the value of @ref gpio_info_regs.gpio_int_en_set.
 * @param  [in]  channel The channel id of gpio.
 * @param  [in]  group The group id of gpio.
 * @param  [in]  group_pin The bit of gpio in group.
 * @param  [in]  val The value of @ref gpio_info_regs.gpio_int_en_set.
 */
static inline void hal_gpio_gpio_int_en_set_set_bit(uint32_t channel, uint32_t group, uint32_t group_pin)
{
    gpios_v150_regs(channel)->gpio_group_cfg[group].gpio_int_en_set =
        hal_gpio_set_bit_high(gpios_v150_regs(channel)->gpio_group_cfg[group].gpio_int_en_set, group_pin);
}

/**
 * @brief  Set the value of @ref gpio_info_regs.gpio_int_en_clr.
 * @param  [in]  channel The channel id of gpio.
 * @param  [in]  group The group id of gpio.
 * @param  [in]  group_pin The bit of gpio in group.
 * @param  [in]  val The value of @ref gpio_info_regs.gpio_int_en_clr.
 */
static inline void hal_gpio_gpio_int_en_clr_set_bit(uint32_t channel, uint32_t group, uint32_t group_pin)
{
    gpios_v150_regs(channel)->gpio_group_cfg[group].gpio_int_en_clr =
        hal_gpio_set_bit_high(gpios_v150_regs(channel)->gpio_group_cfg[group].gpio_int_en_clr, group_pin);
}

/**
 * @brief  Set the value of @ref gpio_info_regs.gpio_int_mask_set.
 * @param  [in]  channel The channel id of gpio.
 * @param  [in]  group The group id of gpio.
 * @param  [in]  group_pin The bit of gpio in group.
 * @param  [in]  val The value of @ref gpio_info_regs.gpio_int_mask_set.
 */
static inline void hal_gpio_gpio_int_mask_set_set_bit(uint32_t channel, uint32_t group, uint32_t group_pin)
{
    gpios_v150_regs(channel)->gpio_group_cfg[group].gpio_int_mask_set =
        hal_gpio_set_bit_high(gpios_v150_regs(channel)->gpio_group_cfg[group].gpio_int_mask_set, group_pin);
}

/**
 * @brief  Set the value of @ref gpio_info_regs.gpio_int_mask_clr.
 * @param  [in]  channel The channel id of gpio.
 * @param  [in]  group The group id of gpio.
 * @param  [in]  group_pin The bit of gpio in group.
 * @param  [in]  val The value of @ref gpio_info_regs.gpio_int_mask_clr.
 */
static inline void hal_gpio_gpio_int_mask_clr_set_bit(uint32_t channel, uint32_t group, uint32_t group_pin)
{
    gpios_v150_regs(channel)->gpio_group_cfg[group].gpio_int_mask_clr =
        hal_gpio_set_bit_high(gpios_v150_regs(channel)->gpio_group_cfg[group].gpio_int_mask_clr, group_pin);
}

/**
 * @brief  Set the value of @ref gpio_info_regs.gpio_int_type_set.
 * @param  [in]  channel The channel id of gpio.
 * @param  [in]  group The group id of gpio.
 * @param  [in]  group_pin The bit of gpio in group.
 * @param  [in]  val The value of @ref gpio_info_regs.gpio_int_type_set.
 */
static inline void hal_gpio_gpio_int_type_set_set_bit(uint32_t channel, uint32_t group, uint32_t group_pin)
{
    gpios_v150_regs(channel)->gpio_group_cfg[group].gpio_int_type_set =
        hal_gpio_set_bit_high(gpios_v150_regs(channel)->gpio_group_cfg[group].gpio_int_type_set, group_pin);
}

/**
 * @brief  Set the value of @ref gpio_info_regs.gpio_int_type_clr.
 * @param  [in]  channel The channel id of gpio.
 * @param  [in]  group The group id of gpio.
 * @param  [in]  group_pin The bit of gpio in group.
 * @param  [in]  val The value of @ref gpio_info_regs.gpio_int_type_clr.
 */
static inline void hal_gpio_gpio_int_type_clr_set_bit(uint32_t channel, uint32_t group, uint32_t group_pin)
{
    gpios_v150_regs(channel)->gpio_group_cfg[group].gpio_int_type_clr =
        hal_gpio_set_bit_high(gpios_v150_regs(channel)->gpio_group_cfg[group].gpio_int_type_clr, group_pin);
}

/**
 * @brief  Set the value of @ref gpio_info_regs.gpio_int_polarity_set.
 * @param  [in]  channel The channel id of gpio.
 * @param  [in]  group The group id of gpio.
 * @param  [in]  group_pin The bit of gpio in group.
 * @param  [in]  val The value of @ref gpio_info_regs.gpio_int_polarity_set.
 */
static inline void hal_gpio_gpio_int_polarity_set_set_bit(uint32_t channel, uint32_t group, uint32_t group_pin)
{
    gpios_v150_regs(channel)->gpio_group_cfg[group].gpio_int_polarity_set =
        hal_gpio_set_bit_high(gpios_v150_regs(channel)->gpio_group_cfg[group].gpio_int_polarity_set, group_pin);
}

/**
 * @brief  Set the value of @ref gpio_info_regs.gpio_int_polarity_clr.
 * @param  [in]  channel The channel id of gpio.
 * @param  [in]  group The group id of gpio.
 * @param  [in]  group_pin The bit of gpio in group.
 * @param  [in]  val The value of @ref gpio_info_regs.gpio_int_polarity_clr.
 */
static inline void hal_gpio_gpio_int_polarity_clr_set_bit(uint32_t channel, uint32_t group, uint32_t group_pin)
{
    gpios_v150_regs(channel)->gpio_group_cfg[group].gpio_int_polarity_clr =
        hal_gpio_set_bit_high(gpios_v150_regs(channel)->gpio_group_cfg[group].gpio_int_polarity_clr, group_pin);
}

/**
 * @brief  Set the value of @ref gpio_info_regs.gpio_int_dedge_set.
 * @param  [in]  channel The channel id of gpio.
 * @param  [in]  group The group id of gpio.
 * @param  [in]  group_pin The bit of gpio in group.
 * @param  [in]  val The value of @ref gpio_info_regs.gpio_int_dedge_set.
 */
static inline void hal_gpio_gpio_int_dedge_set_set_bit(uint32_t channel, uint32_t group, uint32_t group_pin)
{
    gpios_v150_regs(channel)->gpio_group_cfg[group].gpio_int_dedge_set =
        hal_gpio_set_bit_high(gpios_v150_regs(channel)->gpio_group_cfg[group].gpio_int_dedge_set, group_pin);
}

/**
 * @brief  Set the value of @ref gpio_info_regs.gpio_int_dedge_clr.
 * @param  [in]  channel The channel id of gpio.
 * @param  [in]  group The group id of gpio.
 * @param  [in]  group_pin The bit of gpio in group.
 * @param  [in]  val The value of @ref gpio_info_regs.gpio_int_dedge_clr.
 */
static inline void hal_gpio_gpio_int_dedge_clr_set_bit(uint32_t channel, uint32_t group, uint32_t group_pin)
{
    gpios_v150_regs(channel)->gpio_group_cfg[group].gpio_int_dedge_clr =
        hal_gpio_set_bit_high(gpios_v150_regs(channel)->gpio_group_cfg[group].gpio_int_dedge_clr, group_pin);
}

/**
 * @brief  Set the value of @ref gpio_info_regs.gpio_int_debounce_set.
 * @param  [in]  channel The channel id of gpio.
 * @param  [in]  group The group id of gpio.
 * @param  [in]  group_pin The bit of gpio in group.
 * @param  [in]  val The value of @ref gpio_info_regs.gpio_int_debounce_set.
 */
static inline void hal_gpio_gpio_int_debounce_set_set_bit(uint32_t channel, uint32_t group, uint32_t group_pin)
{
    gpios_v150_regs(channel)->gpio_group_cfg[group].gpio_int_debounce_set =
        hal_gpio_set_bit_high(gpios_v150_regs(channel)->gpio_group_cfg[group].gpio_int_debounce_set, group_pin);
}

/**
 * @brief  Set the value of @ref gpio_info_regs.gpio_int_debounce_clr.
 * @param  [in]  channel The channel id of gpio.
 * @param  [in]  group The group id of gpio.
 * @param  [in]  group_pin The bit of gpio in group.
 * @param  [in]  val The value of @ref gpio_info_regs.gpio_int_debounce_clr.
 */
static inline void hal_gpio_gpio_int_debounce_clr_set_bit(uint32_t channel, uint32_t group, uint32_t group_pin)
{
    gpios_v150_regs(channel)->gpio_group_cfg[group].gpio_int_debounce_clr =
        hal_gpio_set_bit_high(gpios_v150_regs(channel)->gpio_group_cfg[group].gpio_int_debounce_clr, group_pin);
}
 ...
 * @param  [in]  group The group id of gpio.
 */
static inline void hal_gpio_gpio_int_en_clr_enable_all(uint32_t channel, uint32_t group)
{
    gpios_v150_regs(channel)->gpio_group_cfg[group].gpio_int_en_clr = 0xFFFFFFFF;
}
 ...
 * @param  [in]  group The group id of gpio.
 */
static inline void hal_gpio_gpio_int_mask_set_enable_all(uint32_t channel, uint32_t group)
{
    gpios_v150_regs(channel)->gpio_group_cfg[group].gpio_int_mask_set = 0xFFFFFFFF;
}
